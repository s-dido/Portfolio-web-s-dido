    ...
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7x1 mx-auto flex flex-row items-start gap-5`}> 
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>"Strengthening the Web3 ecosystem <br className='sm:block hidden'/>through audits and secure practices, I contribute to the growth and integrity of the blockchain industry."</p>
        </div>
      </div>
          <ComputersCanvas/>
